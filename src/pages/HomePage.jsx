...
const HomePage = () => {
  ...
  return (
    <article className="text-center">
      ...
      <p className="max-w-prose mb-12 py-6 rounded-lg bg-neutral-alpha-900 text-neutral-200 text-balance md:text-2xl lg:text-3xl">Read a code snippet & pick the multiple choice question that best explains what it's doing!</p>
